...
Como .pur[intuición básica], los joins permiten .medium-par-red[combinar] dos data frames.
...
.pull-left[
<img src="imagenes/joins_dplyr_nuevo1.PNG" width="300" />
]

--

.pull-rigth[
<img src="imagenes/joins_dplyr_nuevo2.PNG" width="300" />
]
...
1- Generar una base de datos que contenga *first* (nombre), *last* (apellido), *instrument* (instrumento) y la banda (*band*), para **todos** los artistas presentes en la base `artists`.
...
**Nota:** El -4 refiere a la diferencia con GMT - Greenwich Mean Time
